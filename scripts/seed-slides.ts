...
const toolsData = [
    {
        name: 'Palettable',
        slug: 'palettable',
        heading: 'Create stunning color palettes with variations and accessibility checks',
        ...
        isActive: true,
        category: 'color',
        tagline: 'Create beautiful, accessible color palettes in seconds. Test contrast, generate variations, and export to your design system.',
    ...
    },
    {
        name: 'Frames to PDF',
        slug: 'frames-to-pdf',
        heading: 'Turn your designs into share-ready PDFs in seconds',
        ...
        isActive: true,
        category: 'export',
        tagline: 'Export beautiful, print-ready PDFs from your Figma designs with full control over quality, compression, and security.',
    ...
    },
    {
        name: 'Unit Converter',
        slug: 'unit-converter',
        heading: 'Effortlessly convert design dimensions between units',
        ...
        isActive: true,
        category: 'utility',
        tagline: 'Convert units effortlessly with built-in presets for print, web, and custom projects. Perfect for pixel-perfect designs.',
    ...
    },
    {
        name: 'File Importer',
        slug: 'file-importer',
        heading: 'Import files effortlessly with smart font handling and previews',
        ...
        isActive: true,
        category: 'import',
        tagline: 'Import design files seamlessly with smart font detection, live previews, and automatic compatibility checks.',
