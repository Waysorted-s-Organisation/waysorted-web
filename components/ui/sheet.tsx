  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition-transform ease-[cubic-bezier(0.32,0.72,0,1)] data-[state=closed]:duration-500 data-[state=open]:duration-700",
          side === "right" &&
