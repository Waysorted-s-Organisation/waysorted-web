...
const Main: React.FC = () => {
    const { requests, sortBy, activeSort, filterByStatus, activeStatus, loading: globalLoading } = useRequests();
    const { myRequests, loading: myLoading } = useMyRequest();
        ...
        <div className='h-[calc(100vh-68px)] flex-1 flex flex-col z-50 px-6 pt-5'>
            ...
            <div className="space-y-0 w-full">
                {activeTab === "all" ? (
                    ...
                    <div>
                        {(globalLoading || userLoading) ? (
                            <div className="space-y-4">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="flex pl-16 h-[109px] w-full border-b border-gray-100 items-center">
                                        <div className="w-[54px] h-[54px] rounded-md mr-4">
