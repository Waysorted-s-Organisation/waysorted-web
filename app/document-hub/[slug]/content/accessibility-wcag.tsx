export default function AccessibilityWcag() {
  return (
    <>
      <h1 className="text-2xl font-semibold text-secondary-db-100 mb-4">Accessibility (WCAG)</h1>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">WCAG Overview</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Compliance Levels</h2>
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Waysorted Accessibility Tools</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
