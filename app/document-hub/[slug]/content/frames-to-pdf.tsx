export default function PdfExporter() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Export Engine</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Frame-to-PDF conversion, no third-party applications required.
            </p>

            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Frame Selection</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Supports single-frame, multi-frame, and full-page project exports.
            </p>

            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Element Fidelity</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Preserves vector quality, text formatting, and image resolution during conversion to CMYK.
            </p>

            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Output Options</h2>
