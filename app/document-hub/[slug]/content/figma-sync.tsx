export default function FigmaSync() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Architecture</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Data Flow</h2>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Authentication</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
