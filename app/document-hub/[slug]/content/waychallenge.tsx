...
export default function Waychallenge() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Game Mechanics</h2>

            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Objective</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
            ...
            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Controls</h2>
            ...
            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Scoring</h2>
            <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed mt-2">
            ...
            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Game Over</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                The game ends when an object falls on your paddle.
            </p>

            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Difficulty</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
