export default function BackupAndRecovery() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Design File Integrity</h2>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Waysorted Account Data</h2>
            <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
