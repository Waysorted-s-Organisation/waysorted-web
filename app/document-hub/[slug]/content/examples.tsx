export default function Examples() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Basic API Calls</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Common Integration Patterns</h2>
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Code Snippets</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
