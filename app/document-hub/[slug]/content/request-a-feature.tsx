export default function RequestAFeature() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">How to Submit a Request</h2>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">How We Prioritize Suggestions</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Tracking Your Suggestion&apos;s Status</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
