...
export default function OtherFeatures() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">All Tools</h2>
            ...
            <figure className="my-6">
                ...
                <figcaption className="text-sm text-secondary-db-60 mt-2 italic">All Tools interface with categorized tags and favorites</figcaption>
            </figure>

            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Resources</h2>
            <figure className="my-6">
                <div className="rounded-xl overflow-hidden">
                    <Image
                ...
                <figcaption className="text-sm text-secondary-db-60 mt-2 italic">Resources panel with help and community options</figcaption>
            </figure>

            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Help Center</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Find answers to your questions and learn how to use our tools with our comprehensive guides and tutorials.
            </p>

            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Report a Bug</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Help us improve by reporting any issues or unexpected behavior you encounter. Your feedback is crucial to our success.
            </p>

            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Request a Feature</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Share your ideas and suggestions. Help us build the features you need most to make your workflow even better.
            </p>

            <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Join Discord</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
                Connect with our team and other creators. Join the conversation, get support, and share your work in our community.
            </p>

            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">User Profile</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
            ...
            <figure className="my-6">
                ...
                <figcaption className="text-sm text-secondary-db-60 mt-2 italic">User Profile with account details and quick actions</figcaption>
            </figure>
        </>
    );
}
