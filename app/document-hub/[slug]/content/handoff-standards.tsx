export default function HandoffStandards() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Documentation Requirements</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Asset Preparation</h2>
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Communication Best Practices</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
