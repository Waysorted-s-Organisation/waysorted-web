export default function Diagnostics() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Environment Details</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Replication Steps</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Visual Evidence</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
        A screenshot or, ideally, a short screen recording (screencast) of the issue occurring is extremely helpful.
      </p>

      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Error Messages</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
