...
export default function Wayspace() {
    return (
        <>
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Wayspace Overview</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
            ...
            <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Minimized UI</h2>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
