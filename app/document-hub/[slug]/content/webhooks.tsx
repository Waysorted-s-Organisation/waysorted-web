export default function Webhooks() {
  return (
    <>
      <h1 className="text-2xl font-semibold text-secondary-db-100 mb-4">Webhooks</h1>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Setup</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Events:</h2>
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Security:</h2>
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Example Payload (Completed):</h2>
        ...
        {`json
{
  ...
  "signature": "sha256=abc123..."
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Handling in Node.js:</h2>
      <pre className="bg-secondary-db-10 p-4 rounded-lg text-secondary-db-70 text-sm overflow-x-auto mt-4">
        {`javascript
