export default function CommonErrors() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">A Tool Fails to Load or Becomes Unresponsive</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Figma Performance Appears Slower Than Expected</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Exported Assets Are Incorrect or Incomplete</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">A Feature or Setting Appears Missing</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
