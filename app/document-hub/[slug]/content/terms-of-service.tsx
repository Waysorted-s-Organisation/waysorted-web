...
export default function TermsOfService() {
    return (
        <>
            ...
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                These Terms apply to all visitors, users, and others who access or use the Service, including individuals acting on behalf of a company, organization, or other legal entity.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed mt-4 ml-6">
                <li>&quot;Account&quot; means a unique account created by You to access the Service or certain features of the Service.</li>
                <li>&quot;Company&quot;, &quot;We&quot;, &quot;Us&quot;, or &quot;Our&quot; refers to Waysorted Infotech Pvt. Ltd., India.</li>
                <li>&quot;Content&quot; means any text, graphics, logos, icons, images, software, code, design elements, documentation, or other materials made available through the Service.</li>
                <li>&quot;Device&quot; means any device capable of accessing the Service, including a computer, mobile phone, or tablet.</li>
                <li>&quot;Service&quot; refers to the website https://www.waysorted.com and any related tools, plugins, features, or services operated by the Company.</li>
                <li>&quot;Third-Party Services&quot; means any services, tools, plugins, websites, or platforms provided by third parties that may be integrated with or linked from the Service.</li>
            ...
            <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed mt-4 ml-6">
                ...
                <li>If you are accessing or using the Service on behalf of a company, organization, or other legal entity, you have the legal authority to bind that entity to these Terms.</li>
            </ul>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                If you are under the age of 18 (or the age of legal majority in your jurisdiction), you represent that you have obtained consent from your parent or legal guardian to use the Service and to agree to these Terms on your behalf, where required by applicable law.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed mt-4 ml-6">
                <li>Provide accurate, current, and complete information as requested during registration</li>
                <li>Maintain and promptly update your Account information to keep it accurate and complete</li>
            </ul>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                You are responsible for safeguarding your Account credentials, including your password, and for all activities that occur under your Account. You agree not to share your login credentials with any third party.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                You must immediately notify the Company if you become aware of any unauthorized use of your Account or any other security breach. The Company shall not be liable for any loss or damage arising from your failure to protect your Account credentials.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                Subject to your compliance with these Terms, the Company grants you a limited, non-exclusive, non-transferable, and revocable license to access and use the Service solely for your personal or internal business purposes, in accordance with these Terms.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                You may not copy, modify, distribute, sell, lease, sublicense, reverse engineer, or create derivative works from any part of the Service unless expressly permitted by the Company in writing or allowed by applicable law. Any unauthorized use of the Service or its content may result in termination of your access and may give rise to legal liability.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                Waysorted Infotech Pvt. Ltd. does not own, control, or endorse any Third-Party Services and is not responsible for their availability, accuracy, functionality, security, or content. Your use of any Third-Party Services is solely at your own risk and subject to the applicable third party&apos;s terms and policies.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                Free or Beta Features may be provided for evaluation, feedback, or early access purposes and may be modified, updated, suspended, or discontinued at any time. The Company does not guarantee that Free or Beta Features will be available at all times or that they will function without interruption.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                Feedback provided by you shall be deemed non-confidential, and the Company may use, reproduce, or incorporate such Feedback into the Service without restriction or compensation, to the extent permitted by applicable law.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
            ...
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
                We do not have control over, and do not assume responsibility for, the content, policies, practices, or availability of any third-party websites or services. The inclusion of any link does not imply endorsement, affiliation, or sponsorship unless explicitly stated.
            </p>
            <p className="text-secondary-db-70 font-regular text-xl leading-relaxed mt-4">
