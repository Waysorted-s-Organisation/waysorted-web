export default function Palettable() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Core Features</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Accessibility Checks</h2>
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Export</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
