export default function AccountCreationAndSetup() {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Creating an Account</h2>
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Profile Setup</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-secondary-db-100 mt-10 mb-4">Quick Integration with Figma</h2>
      <p className="text-secondary-db-70 font-regular text-xl leading-relaxed">
      ...
      <h2 className="text-lg font-semibold text-secondary-db-100 mt-6 mb-2">Accessing Waysorted in Figma</h2>
