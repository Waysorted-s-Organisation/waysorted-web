...
export default function PricingPage() {
  ...
  const [pricingData, setPricingData] = useState<PricingPayload | null>(null);
      ...
      <section className="w-full px-4 pb-16 pt-10 md:pb-20 md:pt-14">
        <div className="mx-auto w-full max-w-[1040px]">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-[13px] text-[#7A8499]">
              Pricing is resolved server-side for your country and locked during checkout to prevent client-side
              tampering or VPN downgrade loopholes.
            </p>
            ...
            <div className="mt-4 text-[12px] text-[#6B7280]">
              {pricingData ? (
                <>
                  Showing {pricingData.pricing.countryName} pricing · {pricingData.pricing.tier.replace("_", " ")} ·{" "}
                  {pricingData.pricing.currency}
                  {pricingData.pricing.locked ? " · locked to account" : ""}
                </>
              ) : pricingError ? (
                <span className="text-[#B42318]">{pricingError}</span>
              ) : (
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-[1.05fr_1fr]">
              ...
              <div className="flex flex-col">
                ...
                <GlowStarButton
                  ...
                  className="force-hover mt-8 inline-flex w-full cursor-pointer items-center justify-center rounded-xl border border-secondary-db-20 bg-secondary-db-100 px-5 py-[11px] text-[12px] font-semibold text-white transition-transform active:scale-95 disabled:cursor-not-allowed disabled:opacity-60"
                >
